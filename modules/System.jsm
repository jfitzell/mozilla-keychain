...
const EXPORTED_SYMBOLS = ['System'];

var System = {};

System.applicationCreatorCode = function() {
	var bundle = CoreFoundation.CFBundleGetMainBundle();
	if (bundle.isNull())
		throw new Error('Error fetching application bundle');
